...
public class DragonMounts {
    ...
    @NetworkWrapper({MessageDragonInventory.class, MessageDragonBreath.class, MessageDragonFireSupport.class, MessageDragonWhistle.class, MessageDragonGuiSit.class, MessageDragonGuiLock.class, MessageDragonTeleport.class, MessageDragonExtras.class})
