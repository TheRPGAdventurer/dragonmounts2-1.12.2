...
public class RenderWolfMODIFIED extends RenderLiving<EntityWolf>
{
    ...
    public RenderWolfMODIFIED(RenderManager p_i47187_1_) {
        super(p_i47187_1_, new ModelWolfMODIFIED(), 0.5F); 
