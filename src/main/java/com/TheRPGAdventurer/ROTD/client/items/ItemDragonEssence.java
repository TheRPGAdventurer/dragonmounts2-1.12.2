 ...
 public EntityTameableDragon spawnEntityTameableDragon(World world, EntityPlayer player, ItemStack stack, double x, double y, double z) {
 	EntityTameableDragon dragon = new EntityTameableDragon(world);
         try {     
          ...
          stack.setTagCompound(nbt);
         	if(stack.getTagCompound().hasUniqueId("essenceDragonId") && stack.getTagCompound().hasUniqueId("DMessenceOwnerId")) {
            	dragon.setUniqueId(stack.getTagCompound().getUniqueId("DMessenceDragonId"));
          	  dragon.tamedFor(world.getPlayerEntityByUUID(stack.getTagCompound().getUniqueId("DMessenceOwnerId")), true);	
