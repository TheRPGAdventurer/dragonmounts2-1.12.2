...
public class TileEntityDragonShulkerRenderer extends TileEntitySpecialRenderer<TileEntityDragonShulker> {
    ...
    public static final ResourceLocation SHULKER_ENDERGOLEM_TEXTURE =
            new ResourceLocation(DragonMounts.MODID, "textures/blocks/dragon_shulker.png");

    public TileEntityDragonShulkerRenderer(ModelShulker modelIn) {
        this.model = modelIn;
    }
    ...
    public void render(TileEntityDragonShulker te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (destroyStage >= 0) {
            ...
            this.bindTexture(SHULKER_ENDERGOLEM_TEXTURE);
        }
