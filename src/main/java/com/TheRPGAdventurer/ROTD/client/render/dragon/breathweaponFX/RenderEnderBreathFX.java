...
import com.TheRPGAdventurer.ROTD.entity.entitytameabledragon.breath.effects.EnderBreathFX;
...
public class RenderEnderBreathFX extends Render<EnderBreathFX> {
     ...
     */
    public void doRender(EnderBreathFX entity, double x, double y, double z, float entityYaw, float partialTicks) {
