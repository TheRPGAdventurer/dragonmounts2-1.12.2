...
import com.TheRPGAdventurer.ROTD.entity.entitytameabledragon.breath.effects.HydroBreathFX;
...
public class RenderHydroBreathFX extends Render<HydroBreathFX> {
     ...
     */
    public void doRender(HydroBreathFX entity, double x, double y, double z, float entityYaw, float partialTicks) {
     ...
     */
    protected ResourceLocation getEntityTexture(HydroBreathFX entity) {
