...
import com.TheRPGAdventurer.ROTD.entity.entitytameabledragon.breath.effects.PoisonBreathFX;
...
public class RenderPoisonBreathFX extends Render<PoisonBreathFX> {
     ...
     */
    public void doRender(PoisonBreathFX entity, double x, double y, double z, float entityYaw, float partialTicks) {
     ...
     */
    protected ResourceLocation getEntityTexture(PoisonBreathFX entity) {
