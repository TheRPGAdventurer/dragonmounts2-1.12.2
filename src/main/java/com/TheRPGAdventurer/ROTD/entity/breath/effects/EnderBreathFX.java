<<<<<<< HEAD:src/main/java/com/TheRPGAdventurer/ROTD/entity/breath/effects/EnderBreathFX.java
...
>>>>>>> 487f066b... changes:src/main/java/com/TheRPGAdventurer/ROTD/entity/entitytameabledragon/breath/effects/EnderBreathFX.java
...
public class EnderBreathFX extends Entity {
  ...
  private EnderBreathFX(World world, double x, double y, double z, Vec3d motion,
   ...
   */
  public static EnderBreathFX createEnderBreathFX(World world, double x, double y, double z,
    ...
    EnderBreathFX newEnderBreathFX = new EnderBreathFX(world, x, y, z, actualMotion, breathNode);
    return newEnderBreathFX;
  }
