<<<<<<< HEAD:src/main/java/com/TheRPGAdventurer/ROTD/entity/breath/effects/WitherBreathFX.java
...
>>>>>>> 487f066b... changes:src/main/java/com/TheRPGAdventurer/ROTD/entity/entitytameabledragon/breath/effects/WitherBreathFX.java
...
public class WitherBreathFX extends Entity {
  ...
  public static WitherBreathFX createWitherBreathFX(World world, double x, double y, double z,
    ...
    WitherBreathFX newWitherBreathFX = new WitherBreathFX(world, x, y, z, actualMotion, breathNode);
    return newWitherBreathFX;
  }
