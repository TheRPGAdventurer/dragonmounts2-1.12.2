...
class ComponentSound extends PositionedSound implements ITickableSound {
     ...
     * @param i_soundSettings
     */
    protected ComponentSound(SoundEvent soundEvent, SoundCategory soundCategory, float initialVolume, RepeatType i_repeat, ComponentSoundSettings i_soundSettings) {
