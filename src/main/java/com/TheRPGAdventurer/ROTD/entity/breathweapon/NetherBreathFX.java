 ...
 *
 */
public class NetherBreathFX extends Entity {
  ...
  private NetherBreathFX(World world, double x, double y, double z, Vec3d motion,
  ...
  public static NetherBreathFX createNetherBreathFX(World world, double x, double y, double z,
    ...
    NetherBreathFX newNetherBreathFX = new NetherBreathFX(world, x, y, z, actualMotion, breathNode);
