...
public class DragonArmourIce extends DragonArmourBase {
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
		...
		if (!(head == ModArmour.iceDragonScaleCap && chest == ModArmour.iceDragonScaleTunic && legs == ModArmour.iceDragonScaleLeggings && feet == ModArmour.iceDragonScaleBoots)) return;
