...
//		updateForRiding();
   ...
   /**
	...
	/**
	 * Used to get the hand in which to swing and play the hand swinging animation when attacking
	 * In this case the dragon's jaw
	 * 
	 */
	@Override
...
//	}
	...
	public boolean canPassengerSteer2() {
		...
		return entity == this.getControllingPlayer();
	}
