...
public class EntityAIFlyAround extends EntityAIDragonBase {
 ...
 public void startExecuting() {
   ...
   double d0 = dragon.posX + (random.nextFloat() * 3.0F - 1.0F) * 15.0F;
   double d1 = dragon.posY + (random.nextFloat() * 3.0F - 1.0F) * 10.0F;
   double d2 = dragon.posZ + (random.nextFloat() * 3.0F - 1.0F) * 15.0F;
