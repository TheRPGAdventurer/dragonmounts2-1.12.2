...
import com.TheRPGAdventurer.ROTD.server.items.gemset.ItemDragonShovel;
...
public class ModTools {
	...
	static float damage = 10.0F; static float speed = -2.9F; static float netherDamage = 12.0F; static float netherSpeed = -3.0F; static float enderDamage = 9.0F; static float enderSpeed = -3.0F;
	...
	public static ItemDragonAxe waterDragonAxe = new ItemDragonAxe(WaterDragonScaleMaterial, "water_dragon_axe", damage, speed, EnumItemBreedTypes.WATER);
	...
	public static ItemDragonAxe fireDragonAxe = new ItemDragonAxe(FireDragonScaleMaterial, "fire_dragon_axe", damage, speed, EnumItemBreedTypes.FIRE);
	...
	public static ItemDragonAxe fireDragonAxe2 = new ItemDragonAxe(FireDragonScaleMaterial2, "fire2_dragon_axe", damage, speed, EnumItemBreedTypes.FIRE);
	...
	public static ItemDragonAxe iceDragonAxe = new ItemDragonAxe(IceDragonScaleMaterial, "ice_dragon_axe", damage, speed, EnumItemBreedTypes.ICE);
	...
	public static ItemDragonAxe enchantDragonAxe = new ItemDragonAxe(EnchantDragonScaleMaterial, "enchant_dragon_axe", damage, speed, EnumItemBreedTypes.ENCHANT);
	...
	public static ItemDragonAxe stormDragonAxe = new ItemDragonAxe(StormDragonScaleMaterial, "storm_dragon_axe", damage, speed, EnumItemBreedTypes.STORM);
	...
	public static ItemDragonAxe sunlightDragonAxe = new ItemDragonAxe(SunlightDragonScaleMaterial, "sunlight_dragon_axe", damage, speed, EnumItemBreedTypes.SUNLIGHT);
	...
	public static ItemDragonAxe stormDragonAxe2 = new ItemDragonAxe(StormDragonScaleMaterial2, "storm2_dragon_axe", damage, speed, EnumItemBreedTypes.STORM);
	...
	public static ItemDragonAxe sunlightDragonAxe2 = new ItemDragonAxe(SunlightDragonScaleMaterial2, "sunlight2_dragon_axe", damage, speed, EnumItemBreedTypes.SUNLIGHT2);
	...
	public static ItemDragonAxe zombieDragonAxe = new ItemDragonAxe(ZombieDragonScaleMaterial, "zombie_dragon_axe", damage, speed, EnumItemBreedTypes.ZOMBIE);
	...
	public static ItemDragonSword terraDragonSword = new ItemDragonSword(TerraDragonScaleMaterial, "terra_dragon_sword", EnumItemBreedTypes.TERRA);
	public static ItemDragonPickAxe terraDragonPickaxe = new ItemDragonPickAxe(TerraDragonScaleMaterial, "terra_dragon_pickaxe", EnumItemBreedTypes.TERRA);
	public static ItemDragonAxe terraDragonAxe = new ItemDragonAxe(TerraDragonScaleMaterial, "terra_dragon_axe", damage, speed, EnumItemBreedTypes.TERRA);
	...
	public static ItemDragonAxe terraDragonAxe2 = new ItemDragonAxe(TerraDragonScaleMaterial2, "terra2_dragon_axe", damage, speed, EnumItemBreedTypes.TERRA2);
	...
	public static ItemDragonSword moonlightDragonSword = new ItemDragonSword(MoonlightDragonScaleMaterial, "moonlight_dragon_sword", EnumItemBreedTypes.MOONLIGHT);
	public static ItemDragonPickAxe moonlightDragonPickaxe = new ItemDragonPickAxe(MoonlightDragonScaleMaterial, "moonlight_dragon_pickaxe", EnumItemBreedTypes.MOONLIGHT);
	public static ItemDragonAxe moonlightDragonAxe = new ItemDragonAxe(MoonlightDragonScaleMaterial, "moonlight_dragon_axe", damage, speed, EnumItemBreedTypes.MOONLIGHT);
	public static ItemDragonShovel moonlightDragonShovel = new ItemDragonShovel(MoonlightDragonScaleMaterial, "moonlight_dragon_shovel", EnumItemBreedTypes.MOONLIGHT);
	public static ItemDragonHoe moonlightDragonHoe = new ItemDragonHoe(MoonlightDragonScaleMaterial, "moonlight_dragon_hoe", EnumItemBreedTypes.MOONLIGHT);
	...
	public static final Item[] TOOLS = {
		...
		terraDragonSword, terraDragonPickaxe, terraDragonAxe, terraDragonShovel, terraDragonHoe,
		...
		moonlightDragonSword, moonlightDragonPickaxe, moonlightDragonAxe, moonlightDragonShovel, moonlightDragonHoe,
