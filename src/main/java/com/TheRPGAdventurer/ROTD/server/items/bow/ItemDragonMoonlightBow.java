package com.TheRPGAdventurer.ROTD.server.items.bow;
...
public class ItemDragonMoonlightBow extends ItemDragonBow implements IHasModel {

    public EnumItemBreedTypes type;
    public Item repair;

    public ItemDragonMoonlightBow(EnumItemBreedTypes type, Item repair) {
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                if (entityIn == null) {
                    ...
                    return entityIn.getActiveItemStack().getItem() != ModTools.moonlight_dragon_bow ? 0.0F : (float) (stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F;
                }
            }
        });
