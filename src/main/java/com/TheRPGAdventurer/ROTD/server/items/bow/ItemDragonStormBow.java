...
public class ItemDragonStormBow extends ItemDragonBow implements IHasModel {

    public EnumItemBreedTypes type;
    public Item repair;

    public ItemDragonStormBow(EnumItemBreedTypes type, Item repair) {
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                if (entityIn == null) {
                    ...
                    return entityIn.getActiveItemStack().getItem() != ModTools.storm_dragon_bow ? 0.0F : (float) (stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F;
                }
            }
        });
