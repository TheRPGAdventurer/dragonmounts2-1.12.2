...
public class ItemDragonTerra2Bow extends ItemDragonBow implements IHasModel {

    public EnumItemBreedTypes type;
    public Item repair;

    public ItemDragonTerra2Bow(EnumItemBreedTypes type, Item repair) {
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                if (entityIn == null) {
                    ...
                    return entityIn.getActiveItemStack().getItem() != ModTools.terra2_dragon_bow ? 0.0F : (float) (stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F;
                }
            }
        });
