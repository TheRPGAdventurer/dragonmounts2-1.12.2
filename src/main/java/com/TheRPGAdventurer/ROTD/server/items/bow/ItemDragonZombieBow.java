...
public class ItemDragonZombieBow extends ItemBow implements IHasModel {
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                if (entityIn == null) {
                    ...
                    return entityIn.getActiveItemStack().getItem() != ModItems.zombie_dragon_bow ? 0.0F : (float) (stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F;
                }
            }
        });
