...
public class StructureDragonNests {
	...
	public static boolean generate(World world, BlockPos pos, Random rand) {
	   ...
	   // upper
	    ...
	    world.setBlockState(new BlockPos(x+0,y+1,z+0), BlockDragonBreedEgg.DRAGON_BREED_EGG.getStateFromMeta(utils.getRandomWithExclusion(rand, 0, 14, 5,6,7,8,12,13)));
	    return true;
	}   
